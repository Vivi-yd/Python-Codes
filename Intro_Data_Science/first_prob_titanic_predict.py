...
def custom_heuristic(file_path):
    ...
    for passenger_index, passenger in df.iterrows():
        ...
        #
        passenger_id = passenger['PassengerId']
        passenger_status = passenger['Pclass']
        passenger_age = passenger['Age']
        passenger_sex = passenger['Sex']
        embarked_at = passenger['Embarked']
        fare = passenger['Fare']
        ...
        elif passenger_status == 1 and passenger_age < 18:
            predictions[passenger_id] = 1
        
        elif passenger_status == 2 and passenger_age < 13:
            predictions[passenger_id] = 1
        
        
        elif passenger_status == 1 and passenger_age >= 80:
            predictions[passenger_id] = 1
